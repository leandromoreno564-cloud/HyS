...
class InspectionChecklistItem extends Model
{
    ...
    {
        return $this->attributes['categoria_nombre'] ?? $this->attributes['category_name'] ?? null;
    }
    ...
    {
        return $this->attributes['notas'] ?? $this->attributes['notes'] ?? $this->attributes['observacion'] ?? null;
    }
